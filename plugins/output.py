...
REPO_LOCATION = "runcows/noMoreForeverProjectiles"
        ...
        for root, dirs, files in os.walk(TEMPLATES):
            for file in files:
                ...
                rendered_template = template.render(
                    ...
                    modrinth_page = "https://modrinth.com/datapack/no-more-forever-projectiles",
                    github_page = "https://github.com/runcows/noMoreForeverProjectiles",
                )
...
def publish(ctx: Context, zip_name: str, jar_name: str):
    ...
    # Modrinth
    USER_AGENT = "NMFP Github Actions"
    res = requests.get(
